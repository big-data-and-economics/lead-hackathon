...
In some of the docs, you’ll find links to the city GIS map and City on-line tax records, which are linked form the map if you find parcels on the map. (These are the PDFs linked in the documentation folder.)
